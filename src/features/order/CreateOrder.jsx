  ...
  return (
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          <label className="sm:basis-40">Numero de teléfono</label>
          <div className="grow">
            <input className="input w-full" type="tel" name="phone" required />
            {formErrors?.phone && (
              <p className="mt-2 rounded-md text-red-700 text-xs bg-red-100 p-2">
                {formErrors.phone}
              </p>
            )}
          </div>
...
export async function action({ request }) {
  ...
  if (!isValidPhone(order.phone))
    errors.phone =
      "Por favor escriba un numero de celular valido, podriamos necesitarlo para ponernos en contacto con usted";
